...
{
    public class MyButtons : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if(MouseEntered)
            {
                graph.DrawRectangle(new Pen(Color.FromArgb(60,Color.HotPink)), rect);
                graph.FillRectangle(new SolidBrush(Color.FromArgb(60, Color.HotPink)), rect);
            }
            if(MousePressed)
            {
